...
int IntructionCzh();
int ViborKostCzh();
int ViborStavkaCzh(int sumkost);
int gameCzh(int stavka_number, int summkost);
int ResultCzh(int summkost, int stavka_number);
...
int MenuCzh()
{
    ...
    TextHeading.setString(L"   Hra s kostkami\nHlavní nabídka");
    ...
    TextGame.setString(L"Spusťte hru");
    ...
    TextInstruction.setString(L"Návod");
    ...
    TextLanguage.setString(L"Výběr jazyka hry");
    ...
    TextExit.setString(L"Ukončení hry");
...
int IntructionCzh()
{
    ...
    TextInstruction.setString(L"Kostková hra je hra, která simuluje dvě kostky v rozsahu od 1\ndo 6 (celkem až 12). Například: Pokud je součet padlých čísel menší než 7 a hráč uhádl číslo menší než 7,\nvyhrává uzavřenou sázku, pokud je součet padlých čísel větší než 7 a hráč uhodne číslo větší než 7, také vyhrává\nuzavřenou sázku. Pokud hráč uhodne součet čísel,\nzíská čtyřikrát více bodů než vsazená sázka. Pokud nenastane žádná z popsaných situací, sázka je prohraná. V \npočátečním okamžiku má hráč 100 bodů.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Ukončete hru");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Výběr jazyka");
    TextLanguage.setCharacterSize(45);
...
int ViborKostCzh()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Výběr kostkového součtu");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Vybrat\n   ostatní\n   jazyk");
    ...
    TextExplanatory.setString(L"                      Pro další hru vyberte součet kostek.\n(Chcete-li vybrat součet kostek, musíte kliknout na pole s číslem.)");
...
int ViborStavkaCzh(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Výběr sazeb");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Zvolte výši sázky pro další hru.\n(Chcete-li zvolit výši sázky, musíte kliknout na pole s číslem.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameCzh(stavka_number, summkost);
            }
        }
...
int ResultCzh(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Výsledek hry");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Vyhráli jste sázku!");
                ...
                ws1 << L"Vypadly ti kosti " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Součet kostek, které jste si vybrali: " << number_sum_kost << ".";
                ...
                ws3 << L"Součet je: " << sum_kost_console << ".";
                ...
                ws << L"Vaše sázka se zdvojnásobila, vaše sázka je = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Prohrál jsi sázku!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Vaše nabídka byla zrušena, vaše nabídka je = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Vyhráli jste sázku a vyhrajete sázku dalších čtyř!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Vaše sázka se zvýšila o čtyři, vaše sázka je = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
