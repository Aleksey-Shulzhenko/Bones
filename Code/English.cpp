...
int IntructionEng();
int ViborKostEng();
int ViborStavkaEng(int sumkost);
int gameEng(int stavka_number, int summkost);
int ResultEng(int summkost, int stavka_number);

int MenuEng()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Bones", sf::Style::Close);
    ...
    TextHeading.setString(L"   Dice Game\nMain Menu");
    ...
    TextGame.setString(L"Start the hame");
    ...
    TextLanguage.setString(L"Game language selection");
    ...
    TextExit.setString(L"Exiting the game");
    ...
    TextAvtor.setString(L"Author: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionEng()
{
    ...
    TextInstruction.setString(L"The Dice game is a game that simulates two dice in the range from 1\nto 6 (up to 12 in total). For example: If the sum\nof the numbers dropped is less than 7 and the player guessed a number less than 7,\nhe wins the made bet. If the sum of the numbers dropped\nis greater than 7 and the player guessed a number greater than 7, he also wins\nthe made bet. If the player guessed the sum of the numbers, he\nreceives four times more points than the bet made. The bet\nis lost if there is none of the described situations. At the \nstarting moment, the player has 100 points.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"Start the game");
    TextGame.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Quit the game");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Language selection");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Return to the menu");
...
int ViborKostEng()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Choice of dice sum");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Select\n   the other\n   language");
    ...
    TextExplanatory.setString(L"                      Choose the sum of the dice, for further play.\n(To choose the sum of the dice, you need to click on the field with a number.)");
...
int ViborStavkaEng(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Selection of rates");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Choose the amount of the bet, for further play.\n(To choose the amount of the bet, you need to click on the field with a number.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameEng(stavka_number, summkost);
            }
        }
...
int ResultEng(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"The result of the game");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"You won the bet!");
                ...
                ws1 << L"Your bones fell out " << kost1 << L" and " << kost2 << ".";
                ...
                ws2 << L"The sum of the dice you chose: " << number_sum_kost << ".";
                ...
                ws3 << L"The sum is: " << sum_kost_console << ".";
                ...
                ws << L"Your bet has doubled, your bet is = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"You lost the bet!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Your bid has been cancelled, your bid is = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Your bet increased by four, your bet is = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
