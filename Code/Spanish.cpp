...
int IntructionSp();
int ViborKostSp();
int ViborStavkaSp(int sumkost);
int gameSp(int stavka_number, int summkost);
int ResultSp(int summkost, int stavka_number);

int MenuSp()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Huesos", sf::Style::Close);
    ...
    TextHeading.setString(L"Juego de dados\n Menú principal");
    ...
    TextGame.setString(L"Comienza el juego");
    ...
    TextInstruction.setString(L"Instrucción");
...
int IntructionSp()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Instrucción");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"El juego de dados es un juego que simula dos dados en el rango del 1 al 6 (hasta 12 en total). Por ejemplo: si la suma de los números arrojados es menor que 7 y el jugador adivinó un número menor que 7, gana la apuesta realizada. Si la suma de los números arrojados es mayor que 7 y el jugador adivinó un número. mayor que 7, también gana\nla apuesta realizada. Si el jugador adivina la suma de los números,\nrecibe cuatro veces más puntos que la apuesta realizada. La apuesta se pierde si no se da ninguna de las situaciones descritas. En el \nmomento inicial, el jugador tiene 100 puntos.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Salir del juego");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Selección de idioma");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Пvolver al menú");
...
int ViborKostSp()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Elección de la suma de los dados");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(380, 30);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Salir del \n    juego");
    TextExit.setCharacterSize(45);
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(100, 550);

    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"Comenzar\n   el juego\n   recién");
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Seleccionar\n   el otro\n   idioma");
    ...
    TextExplanatory.setString(L"                      Elige la suma de los dados para seguir jugando.\n(Para elegir la suma de los dados, debes hacer clic en el campo con un número).");
    TextExplanatory.setCharacterSize(40);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(350, 800);
...
int ViborStavkaSp(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Selección de tarifas");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Elija el monto de la apuesta para seguir jugando.\n(Para elegir el monto de la apuesta, debe hacer clic en el campo con un número).");
    TextExplanatory.setCharacterSize(40);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(350, 800);
...
int ResultSp(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"El resultado del juego.");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Volver al menú");
    TextMenu.setCharacterSize(30);
    TextMenu.setFillColor(sf::Color::White);
    TextMenu.setPosition(1070, 885);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"¡Ganaste la apuesta!");
                ...
                ws1 << L"Tus huesos se cayeron " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"La suma de los dados que elegiste: " << number_sum_kost << ".";
                ...
                ws3 << L"La suma es: " << sum_kost_console << ".";
                ...
                ws << L"Tu apuesta se ha duplicado, tu apuesta es = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"¡Perdiste la apuesta!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Su oferta ha sido cancelada, su oferta es =" << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"¡Has ganado una apuesta y ganarás una apuesta de cuatro más!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Tu apuesta aumentó en cuatro, tu apuesta es =" << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
