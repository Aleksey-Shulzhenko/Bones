...
int IntructionHun();
int ViborKostHun();
int ViborStavkaHun(int sumkost);
int gameHun(int stavka_number, int summkost);
int ResultHun(int summkost, int stavka_number);

int MenuHun()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Csontok", sf::Style::Close);
...
int IntructionHun()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Oktatás");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(830, 30);

    sf::Text TextInstruction;
    TextInstruction.setFont(FontExplanatory);
    TextInstruction.setString(L"A kockajáték egy olyan játék, amely két kockát szimulál 1 és 6 \nközötti tartományban (összesen 12-ig). Például: Ha az elejtett \nszámok összege kisebb, mint 7, és a játékos 7-nél kisebb számot \ntippelt,megnyeri a megtett tétet, ha a számok összege 7-nél \nnagyobb, és a játékos kitalált egy számot 7-nél nagyobb, a \nmegtett fogadást is megnyeri. Ha a játékos kitalálta a számok \nösszegét,négyszer több pontot kap, mint a megtett tét. A fogadás \nelveszett, ha a leírt helyzetek egyike sem következik be. A kezdés \npillanatában a játékosnak 100 pontja van.");
    TextInstruction.setCharacterSize(45);
    ...
    TextGame.setPosition(1510, 875);

    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Hagyd ki a játékot");
    TextExit.setCharacterSize(45);
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(90, 875);

    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Nyelvválasztás");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Vissza a menübe");
...
int ViborKostHun()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"A kockaösszeg kiválasztása");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(480, 30);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Hagyd ki a \n  játékot");
    TextExit.setCharacterSize(45);
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(85, 560);

    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"      Indul\n    a játékot\n   újonnan");
    TextGame.setCharacterSize(35);
    TextGame.setFillColor(sf::Color::White);
    TextGame.setPosition(490, 550);

    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"  Visszatérés\n       hogy\n       menü");
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Válassza ki\n  a másik\n   nyelv");
    ...
    TextExplanatory.setString(L"                      Válassza ki a kocka összegét a további játékhoz.\n(A kocka összegének kiválasztásához kattintson a számot tartalmazó mezőre.)");
    TextExplanatory.setCharacterSize(50);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(160, 800);
...
int ViborStavkaHun(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Az árfolyamok kiválasztása");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(480, 30);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Válassza ki a tét összegét a további játékhoz.\n(A tét összegének kiválasztásához kattintson a számot tartalmazó mezőre.)");
    TextExplanatory.setCharacterSize(50);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(180, 800);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameHun(stavka_number, summkost);
            }
        }
...
int ResultHun(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"A játék eredménye");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(600, 0);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Megnyerted a fogadást!");
                ...
                ws1 << L"Kihullottak a csontjaid " << kost1 << L" és " << kost2 << ".";
                ...
                ws2 << L"A választott kocka összege: " << number_sum_kost << ".";
                ...
                ws3 << L"Az összeg: " << sum_kost_console << ".";
                ...
                ws << L"A tét megduplázódott, a tét = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
                TextHeading.setPosition(700, 600);
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Elvesztetted a fogadást!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Ajánlatát törölték, ajánlata = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
                TextHeading.setPosition(700, 600);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Ön nyert egy fogadást, és nyerni fog egy további négy fogadást!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"A tét néggyel nőtt, a tét = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(700, 600);
