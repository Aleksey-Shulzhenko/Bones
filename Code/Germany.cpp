...
int IntructionGer();
int ViborKostGer();
int ViborStavkaGer(int sumkost);
int gameGer(int stavka_number, int summkost);
int ResultGer(int summkost, int stavka_number);

int MenuGer()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Knochen", sf::Style::Close);
    ...
    TextHeading.setString(L"   Würfelspiel\n   Hauptmenü");
...
int IntructionGer()
{
    ...
    SpriteInstruction.setScale(1.25, 1.07);
    SpriteInstruction.setPosition(260, 130);
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Anweisung");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Das Würfelspiel ist ein Spiel, das zwei Würfel im Bereich von 1 \nbis 6 (insgesamt bis zu 12) simuliert. Beispiel: Wenn die Summe \nder fallengelassenen Zahlen kleiner als 7 ist und der Spieler eine \nZahl unter 7 erraten hat, gewinnt er die abgeschlossene Wette. \nWenn die Summe der gefallenen Zahlen größer als 7 ist und der \nSpieler eine Zahl erraten hat größer als 7, gewinnt er auch den \nabgeschlossenen Einsatz. Wenn der Spieler die Summe der \nZahlen erraten hat, erhält er viermal mehr Punkte als der \ngetätigte Einsatz. Die Wette ist verloren, wenn keine der \nbeschriebenen Situationen vorliegt. Zum Startzeitpunkt hat der \nSpieler 100 Punkte.");
    TextInstruction.setCharacterSize(45);
    TextInstruction.setFillColor(sf::Color::White);
    TextInstruction.setPosition(290, 160);
    ...
    TextGame.setPosition(1540, 855);

    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Beenden Sie das \n           Spiel");
    TextExit.setCharacterSize(45);
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(100, 845);

    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Sprachauswahl");
    TextLanguage.setCharacterSize(45);
    TextLanguage.setFillColor(sf::Color::White);
    TextLanguage.setPosition(580, 875);

    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Zurück zum Menü");
    TextMenu.setCharacterSize(45);
    TextMenu.setFillColor(sf::Color::White);
    TextMenu.setPosition(1050, 875);
...
int ViborKostGer()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Wahl der Würfelsumme");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(560, 30);
    ...
    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Zurückkehren\n          zu\n  speisekarte");
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"  Wählen\nder andere\n  sprache");
    TextLanguage.setCharacterSize(35);
    TextLanguage.setFillColor(sf::Color::White);
    TextLanguage.setPosition(1660, 550);

    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Wählen Sie die Summe der Würfel für das weitere Spiel.\n(Um die Summe der Würfel auszuwählen, müssen Sie auf das Feld mit einer Zahl klicken.)");
    TextExplanatory.setCharacterSize(45);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(140, 800);
...
int ViborStavkaGer(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Auswahl an Tarifen");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Wählen Sie den Einsatzbetrag für das weitere Spiel.\n(Um den Einsatzbetrag auszuwählen, müssen Sie auf das Feld mit einer Zahl klicken.)");
    TextExplanatory.setCharacterSize(45);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(200, 800);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameGer(stavka_number, summkost);
            }
        }
...
int ResultGer(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Das Ergebnis des Spiels");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(680, 0);
    ...
    TextLanguage.setCharacterSize(45);
    TextLanguage.setFillColor(sf::Color::White);
    TextLanguage.setPosition(570, 875);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Du hast die Wette gewonnen!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(700, 200);
                ...
                ws1 << L"Deine Knochen sind herausgefallen " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Die Summe der von Ihnen gewählten Würfel: " << number_sum_kost << ".";
                ...
                ws3 << L"Die Summe ist: " << sum_kost_console << ".";
                TextHeading4.setString(ws3.str());
                TextHeading4.setCharacterSize(50);
                TextHeading4.setFillColor(sf::Color::White);
                TextHeading4.setPosition(700, 500);

                sf::Text TextHeading;
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Ihr Einsatz hat sich verdoppelt, Ihr Einsatz beträgt = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < 7.2)
            {
                if (sum_kost_console > number_sum_kost)
                {
                    ...
                    TextHeading2.setFont(FontArimoSemiBold);
                    std::wstringstream ws1;
                    ws1 << L"Deine Knochen sind herausgefallen " << kost1 << L" und " << kost2 << ".";
                    TextHeading2.setString(ws1.str());
                    TextHeading2.setCharacterSize(50);
                    TextHeading2.setFillColor(sf::Color::White);
                    TextHeading2.setPosition(700, 300);
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Du hast die Wette verloren!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(700, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Ihr Gebot wurde storniert, Ihr Gebot ist = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
                TextHeading.setPosition(300, 600);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Sie haben eine Wette gewonnen und gewinnen noch eine weitere Wette!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(500, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Ihr Einsatz erhöht sich um vier, Ihr Einsatz beträgt =" << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(300, 600);
