...
int IntructionKaz();
int ViborKostKaz();
int ViborStavkaKaz(int sumkost);
int gameKaz(int stavka_number, int summkost);
int ResultKaz(int summkost, int stavka_number);

int MenuKaz()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Сүйектер", sf::Style::Close);
    ...
    TextHeading.setString(L"   Дис ойыны\nНегізгі мәзір");
    ...
    TextGame.setString(L"Ойынды бастаңыз");
    ...
    TextInstruction.setString(L"Нұсқау");
    ...
    TextLanguage.setString(L"Ойын тілін таңдау");
    ...
    TextExit.setString(L"Ойыннан шығу");
    ...
    TextAvtor.setString(L"Авторы: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionKaz()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Нұсқау");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Dice ойыны — 1\n6 аралығындағы екі сүйекті имитациялайтын ойын (барлығы 12-ге дейін). Мысалы: Егер түсірілген сандардың қосындысы\n7-ден аз болса және ойыншы 7-ден аз санды тапса,\nсандардың қосындысы 7-ден көп болса және ойыншы бір санды тапса, ол жасалған ставканы жеңеді 7-ден жоғары болса, ол жасалған бәсті\nұтып алады. Ойыншы сандардың қосындысын тапса, ол жасалған бәс тігуден төрт есе көп ұпай алады. Сипатталған жағдайлардың ешқайсысы болмаса, ұтыс тігунұтылды. \nбастапқы сәтте ойыншыда 100 ұпай бар.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Ойынды шығыңыз");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Тіл таңдау");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Мәзірге оралу");
...
int ViborKostKaz()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Сүйектер сомасын таңдау");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"таңдаңыз\n   басқа\n   тіл");
    ...
    TextExplanatory.setString(L"                      Әрі қарай ойнау үшін сүйектердің қосындысын таңдаңыз.\n(Күйектердің қосындысын таңдау үшін саны бар өрісті басу керек.)");
...
int ViborStavkaKaz(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Тарифтерді таңдау");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Одан әрі ойнау үшін ұтыс тігу сомасын таңдаңыз.\n(Бәс тігу сомасын таңдау үшін нөмір бар өрісті басу керек.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameKaz(stavka_number, summkost);
            }
        }
...
int ResultKaz(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Ойынның нәтижесі");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Сіз бәс тігуді ұтып алдыңыз!");
                ...
                ws1 << L"Сүйектерің түсіп қалды " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Сіз таңдаған сүйектердің қосындысы: " << number_sum_kost << ".";
                ...
                ws3 << L"Бұл сома: " << sum_kost_console << ".";
                ...
                ws << L"Сіздің ұтыс тігуіңіз екі есе артты, сіздің ставкаңыз = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Сіз бәс тігуден ұтылдыңыз!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Сіздің ұсынысыңыз жойылды, сіздің ұсынысыңыз = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Сіз бәс тігуді ұтып алдыңыз және тағы төрт ставка ұтып аласыз!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Сіздің ұтыс тігуіңіз төртке өсті, сіздің ставкаңыз = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
