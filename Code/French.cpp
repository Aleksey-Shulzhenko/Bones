...
int IntructionFr();
int ViborKostFr();
int ViborStavkaFr(int sumkost);
int gameFr(int stavka_number, int summkost);
int ResultFr(int summkost, int stavka_number);

int MenuFr()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Os", sf::Style::Close);
    ...
    TextHeading.setString(L"   Jeu de dés\nMenu principal");
    ...
    TextGame.setString(L"Commencer le jeu");
    ...
    TextInstruction.setString(L"Instruction");
    ...
    TextLanguage.setString(L"Sélection de la langue du jeu");
    ...
    TextExit.setString(L"Quitter le jeu");
    ...
    TextAvtor.setString(L"Auteur: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionFr()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Instruction");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Le jeu de dés est un jeu qui simule deux dés allant de 1 à 6 (jusqu'à 12 au total). Par exemple : Si la somme\ndes nombres sortis est inférieure à 7 et que le joueur a deviné un nombre inférieur à 7,\nil remporte le pari effectué. Si la somme des nombres sortis\nest supérieure à 7 et que le joueur a deviné un nombre. supérieur à 7, il remporte également\nle pari effectué. Si le joueur devine la somme des nombres, il\nreçoit quatre fois plus de points que le pari effectué. Le pari est perdu si aucune des situations décrites ne se produit. Au moment de départ, le joueur dispose de 100 points.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Quitte le jeu");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Sélection de la langue");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Retour au menu");
...
int ViborKostFr()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Choix de la somme des dés");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"Commencer\n       le jeu\n   nouvellement");
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Sélectionner\n   l'autre\n   langue");
    ...
    TextExplanatory.setString(L"                      Choisissez la somme des dés, pour continuer à jouer.\n(Pour choisir la somme des dés, vous devez cliquer sur le champ avec un nombre.)");
...
int ViborStavkaFr(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Sélection de tarifs");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Choisissez le montant du pari, pour continuer à jouer.\n(Pour choisir le montant du pari, vous devez cliquer sur le champ avec un numéro.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
...
int ResultFr(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Le résultat du jeu");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Vous avez gagné le pari !");
                ...
                ws1 << L"Tes os sont tombés " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"La somme des dés que vous avez choisis : " << number_sum_kost << ".";
                ...
                ws3 << L"La somme est : " << sum_kost_console << ".";
                ...
                ws << L"Votre mise a doublé, votre mise est = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Vous avez perdu le pari !");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Votre enchère a été annulée, votre enchère est = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Vous avez gagné un pari et vous gagnerez un pari de quatre autres !");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Votre mise a augmenté de quatre, votre mise est = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
