...
int IntructionUkr();
int ViborKostUkr();
int ViborStavkaUkr(int sumkost);
int gameUkr(int stavka_number, int summkost);
int ResultUkr(int summkost, int stavka_number);
...
int MenuUkraine()
{
    ...
    TextHeading.setString(L"   Гра Кістки\nГоловне меню"); 
    ...
    TextGame.setString(L"Розпочати гру"); 
    ...
    TextInstruction.setString(L"Інструкція"); 
    ...
    TextLanguage.setString(L"Вибір мови гри"); 
    ...
    TextExit.setString(L"Вихід з гри"); 
...
int IntructionUkr()
{
    ...
    sf::Text TextHeading; 
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Інструкція"); 
    TextHeading.setCharacterSize(75.6); 
    TextHeading.setFillColor(sf::Color::White); 
    ...
    TextInstruction.setString(L"Гра Кiстки - це гра, яка моделює два кубика в дiапазонi вiд 1\nдо 6 (в сумарностi виходить ДО 12). Наприклад: Якщо сума\nцифр, щo випали менше 7 i гравець задумав число менше 7,\nвiн виграє зроблену ставку.Якщо сума цифр, що випали\nбiльше 7 i гравець задумав число бiльше 7, вiн також виграє\nзроблену ставку. Якщо граючий вгадав суму цифр, вiн\nотримує вчетверо бiльше очок, нiж зроблена ставка. Ставка\nпрограна, якщо немає жодна з описаних cитуацiй. У \nпочатковий момент у того, хто грає 100 очок.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Вибір мови");
    TextLanguage.setCharacterSize(45);
...
int ViborKostUkr()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Вибір суми кісток");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"Розпочати\n       гру\n   заново");
    ...
    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Повернутися\n          до\n       меню");
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Обрати\n   іншу\n   мову");
    ...
    TextExplanatory.setString(L"                      Виберіть суму кісток, для подальшої гри.\n(Щоб обрати суму кісток, потрібно натиснути на поле з цифрою.)"); 
...
int ViborStavkaUkr(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Вибір ставок");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory; 
    TextExplanatory.setFont(FontCalibril); 
    TextExplanatory.setString(L"                      Виберіть суму ставки, для подальшої гри.\n(Щоб обрати сумму ставки, потрібно натиснути на поле з цифрою.)"); 
    TextExplanatory.setCharacterSize(60); 
    TextExplanatory.setFillColor(sf::Color::White); 
    TextExplanatory.setPosition(120, 780); 
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameUkr(stavka_number, summkost);
            }
        }
...
int ResultUkr(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Результат гри");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < 7.2)
            {
                if (sum_kost_console > number_sum_kost)
                {
                    ...
                    TextHeading2.setFont(FontArimoSemiBold);
                    std::wstringstream ws1;
                    ws1 << L"Вам випали кiстки " << kost1 << L" та " << kost2 << ".";
                    TextHeading2.setString(ws1.str());
                    TextHeading2.setCharacterSize(50);
                    TextHeading2.setFillColor(sf::Color::White);
                    TextHeading2.setPosition(700, 300);
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Ви програли ставку!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Ваша ставка анульовано, ваша ставка становить = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
