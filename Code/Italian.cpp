...
int IntructionIt();
int ViborKostIt();
int ViborStavkaIt(int sumkost);
int gameIt(int stavka_number, int summkost);
int ResultIt(int summkost, int stavka_number);

int MenuIt()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Ossa", sf::Style::Close);
    ...
    TextHeading.setString(L"   Gioco di dadi\nMenu principale");
    ...
    TextGame.setString(L"Inizia il gioco");
    ...
    TextInstruction.setString(L"Istruzioni");
    ...
    TextLanguage.setString(L"Selezione della lingua del gioco");
    ...
    TextExit.setString(L"Uscire dal gioco");
    ...
    TextAvtor.setString(L"Autore: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionIt()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Istruzioni");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Il gioco dei dadi è un gioco che simula due dadi nell'intervallo da 1 a 6 (fino a 12 in totale). Ad esempio: Se la somma\ndei numeri eliminati è inferiore a 7 e il giocatore ha indovinato un numero inferiore a 7,\nvince la scommessa effettuata. Se la somma dei numeri eliminati\nè maggiore di 7 e il giocatore ha indovinato un numero maggiore di 7, vince anche\nla scommessa effettuata. Se il giocatore indovina la somma dei numeri, riceve\nquattro volte più punti della scommessa effettuata. La scommessa\nè persa se non si verifica nessuna delle situazioni descritte. Al\nmomento iniziale, il giocatore ha 100 punti.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Esci dal gioco");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Selezione della lingua");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Ritorna al menù");
...
int ViborKostIt()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Scelta della somma dei dadi");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Selezionare\n   l'altro\n   lingua");
    ...
    TextExplanatory.setString(L"                      Scegli la somma dei dadi, per giocare ulteriormente.\n(Per scegliere la somma dei dadi, devi fare clic sul campo con un numero.)");
...
int ViborStavkaIt(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Selezione delle tariffe");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Scegli l'importo della scommessa, per giocare ulteriormente.\n(Per scegliere l'importo della scommessa, devi fare clic sul campo con un numero.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
...
int ResultIt(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Il risultato del gioco");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Hai vinto la scommessa!");
                ...
                ws1 << L"Ti sono cadute le ossa " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"La somma dei dadi che hai scelto: " << number_sum_kost << ".";
                ...
                ws3 << L"La somma dei dadi che hai scelto: " << sum_kost_console << ".";
                ...
                ws << L"La tua scommessa è raddoppiata, la tua scommessa è = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Hai perso la scommessa!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"La tua offerta è stata annullata, la tua offerta è =" << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Hai vinto una scommessa e ne vincerai altre quattro!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"La tua scommessa è aumentata di quattro, la tua scommessa è = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
