...
int IntructionNor();
int ViborKostNor();
int ViborStavkaNor(int sumkost);
int gameNor(int stavka_number, int summkost);
int ResultNor(int summkost, int stavka_number);

int MenuNor()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Bein", sf::Style::Close);
    ...
    TextHeading.setString(L"   Terningspill\nHovedmeny");
    ...
    TextGame.setString(L"Start spillet");
    ...
    TextInstruction.setString(L"Undervisning");
    ...
    TextLanguage.setString(L"Valg av spillspråk");
    ...
    TextExit.setString(L"Går ut av spillet");
    ...
    TextAvtor.setString(L"Forfatter: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionNor()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Undervisning");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Terningspillet er et spill som simulerer to terninger i området fra 1\ntil 6 (opptil 12 totalt). For eksempel: Hvis summen av tallene som er falt er mindre enn 7 og spilleren gjettet et tall som er mindre enn 7, vinner han innsatsen hvis summen av tallene er mindre enn 7 og spilleren gjettet et tall større enn 7, vinner han også\ninnsatsen. Hvis spilleren gjettet summen av tallene, får han fire ganger flere poeng enn innsatsen. Innsatsen er tapt hvis det ikke er noen av de beskrevne situasjonene. I startøyeblikket har spilleren 100 poeng.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Avslutt spillet");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Språkvalg");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Språkvalg");
...
int ViborKostNor()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Valg av terning sum");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Velge\n   den andre\n   språk");
    ...
    TextExplanatory.setString(L"                      Velg summen av terningene for videre spill.\n(For å velge summen av terningene må du klikke på feltet med et tall.)");
...
int ViborStavkaNor(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Valg av priser");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Velg innsatsbeløpet for videre spill.\n(For å velge innsatsbeløpet må du klikke på feltet med et tall.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameNor(stavka_number, summkost);
            }
        }
...
int ResultNor(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Resultatet av spillet");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Gå tilbake til menyen");
    TextMenu.setCharacterSize(30);
    TextMenu.setFillColor(sf::Color::White);
    TextMenu.setPosition(1070, 885);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Du vant innsatsen!");
                ...
                ws1 << L"Beina dine falt ut " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Summen av terningene du valgte: " << number_sum_kost << ".";
                ...
                ws3 << L"Summen er: " << sum_kost_console << ".";
                ...
                ws << L"Innsatsen din er doblet, innsatsen din er = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Du tapte innsatsen!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Budet ditt er kansellert, budet ditt er = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Du har vunnet en innsats og vil vinne en innsats på fire til!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Innsatsen din økt med fire, innsatsen din er = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
