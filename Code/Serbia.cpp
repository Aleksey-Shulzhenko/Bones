...
int IntructionSer();
int ViborKostSer();
int ViborStavkaSer(int sumkost);
int gameSer(int stavka_number, int summkost);
int ResultSer(int summkost, int stavka_number);

int MenuSer()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Бонес", sf::Style::Close);
    ...
    TextHeading.setString(L"   Игра с коцкицама\nГлавни мени");
    ...
    TextGame.setString(L"Започните игру");
    ...
    TextInstruction.setString(L"Упутство");
    ...
    TextLanguage.setString(L"Избор језика игре");
    ...
    TextExit.setString(L"Излазак из игре");
    ...
    TextAvtor.setString(L"Аутор: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionSer()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Упутство");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Игра коцкица је игра која симулира две коцкице у распону од 1\nндо 6 (укупно до 12). На пример: Ако је збир испуштених бројева мањи од 7 и играч је погодио број мањи од 7,\nнпобеђује ако је збир бројева пао већи од 7 и играч је погодио број већи од 7, он такође добија\nнучињену опкладу. Ако је играч погодио збир бројева, он\nндобива четири пута више поена од уложене опкладе. Опклада се губи ако не постоји ниједна од описаних ситуација. У \nнпочетном тренутку, играч има 100 поена.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Прекините игру");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Избор језика");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Вратите се на мени");
...
int ViborKostSer()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Избор збира коцкица");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Изаберите\n   други\n   језик");
    ...
    TextExplanatory.setString(L"                      Изаберите збир коцкица, за даљу игру.\n(Да бисте изабрали збир коцкица, потребно је да кликнете на поље са бројем.)");
...
int ViborStavkaSer(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Избор стопа");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Изаберите износ опкладе, за даље играње.\n(Да бисте изабрали износ опкладе, потребно је да кликнете на поље са бројем.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameSer(stavka_number, summkost);
            }
        }
...
int ResultSer(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Резултат игре");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Добио си опкладу!");
                ...
                ws1 << L"Кости су ти испале " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Збир коцкица који сте изабрали: " << number_sum_kost << ".";
                ...
                ws3 << L"Збир је: " << sum_kost_console << ".";
                ...
                ws << L"Ваша опклада се удвостручила, ваша опклада је = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Изгубио си опкладу!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Ваша понуда је поништена, ваша понуда је = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Добили сте опкладу и добићете опкладу на још четири!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Ваша опклада је повећана за четири, ваша опклада је = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
