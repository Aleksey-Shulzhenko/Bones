...
int IntructionBel();
int ViborKostBel();
int ViborStavkaBel(int sumkost);
int gameBel(int stavka_number, int summkost);
int ResultBel(int summkost, int stavka_number);

int MenuBel()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Косці", sf::Style::Close);
    ...
    TextHeading.setString(L" Гульня ў косці\nГалоўнае меню");
    ...
    TextAvtor.setString(L"Аўтар: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionBel()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Інструкцыя");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Гульня Косці - гэта гульня, якая імітуе дзве косткі ў \nдыяпазоне ад 1 да 6 (усяго да 12). Напрыклад: Калі сума \nвыпаўшых лікаў меншая за 7 і гулец адгадаў лік, ён выйграў \nзробленую стаўку, калі сума выпаўшых лікаў большая за 7 і \nгулец адгадаў лік больш за 7, ён таксама выйграе зробленую \nстаўку. Калі гулец адгадаў суму лікаў, ён атрымлівае ў \nчатыры разы больш ачкоў, чым зробленая стаўка. Стаўка \nпрайграна, калі няма ніводнай з апісаных сітуацый. У \nстартавы момант гулец мае 100 ачкоў.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Выйсці з гульні");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Выбар мовы");
    ...
    TextMenu.setString(L"Вярніцеся ў меню");
...
int ViborKostBel()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Выбар сумы ў косці");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(95, 590);

    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"Пачаць\n  гульня\n нанова");
    TextGame.setCharacterSize(35);
    TextGame.setFillColor(sf::Color::White);
    TextGame.setPosition(520, 550);

    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Вярнуцца\n     каб\n   меню");
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Выберыце\n     іншы\n     мове");
    TextLanguage.setCharacterSize(35);
    TextLanguage.setFillColor(sf::Color::White);
    ...
    TextExplanatory.setString(L"                      Выберыце суму кубікаў, для далейшай гульні.\n(Каб выбраць суму кубікаў, вам трэба націснуць на поле з лічбай.)");
...
int ViborStavkaBel(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Падбор ставак");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Абярыце суму стаўкі, для далейшай гульні.\n(Каб выбраць суму стаўкі, трэба націснуць на поле з лічбай.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(150, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameBel(stavka_number, summkost);
            }
        }
...
int ResultBel(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Вынік гульні");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Вы выйгралі стаўку!");
                ...
                ws1 << L"Твае косці выпалі " << kost1 << L" і " << kost2 << ".";
                ...
                ws2 << L"Сума кубікаў, якую вы абралі: " << number_sum_kost << ".";
                ...
                ws << L"Ваша стаўка падвоілася, ваша стаўка = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Вы прайгралі стаўку!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Ваша стаўка была адменена, ваша стаўка = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Ваша стаўка павялічана на чатыры, ваша стаўка = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
