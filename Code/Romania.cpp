...
int IntructionRom();
int ViborKostRom();
int ViborStavkaRom(int sumkost);
int gameRom(int stavka_number, int summkost);
int ResultRom(int summkost, int stavka_number);

int MenuRom()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Oasele", sf::Style::Close);
    ...
    TextHeading.setString(L"   Jocul cu zaruri\nMeniul principal");
    ...
    TextGame.setString(L"Începe jocul");
    ...
    TextInstruction.setString(L"Instruire");
    ...
    TextLanguage.setString(L"Selectarea limbii jocului");
    ...
    TextExit.setString(L"Ieșirea din joc");
...
int IntructionRom()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Instruire");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Jocul Dice este un joc care simulează două zaruri în intervalul de la 1\ la 6 (până la 12 în total). De exemplu: dacă suma numerelor scăzute este mai mică de 7 și jucătorul a ghicit un număr mai mic de 7, el câștigă pariul făcut dacă suma numerelor a scăzut mai mult de 7 și jucătorul a ghicit un număr mai mare de 7, el câștigă și\npariul făcut. Dacă jucătorul a ghicit suma numerelor, el primește de patru ori mai multe puncte decât pariul făcut. Pariul este pierdut dacă nu există niciuna dintre situațiile descrise. La \nmomentul de început, jucătorul are 100 de puncte.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Părăsiți jocul");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Selectarea limbii");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Reveniți la meniu");
...
int ViborKostRom()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Alegerea sumei zarurilor");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Selecta\n   celelalte\n   limbă");
    ...
    TextExplanatory.setString(L"                      Alegeți suma zarurilor, pentru continuarea jocului.\n(Pentru a alege suma zarurilor, trebuie să faceți clic pe câmpul cu un număr.)");
...
int ViborStavkaRom(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Selectarea tarifelor");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Alegeți valoarea pariului, pentru continuarea jocului.\n(Pentru a alege valoarea pariului, trebuie să faceți clic pe câmpul cu un număr.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameRom(stavka_number, summkost);
            }
        }
...
int ResultRom(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Rezultatul jocului");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Ai câștigat pariul!");
                ...
                ws1 << L"Ți-au căzut oasele " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Suma zarurilor pe care le-ați ales: " << number_sum_kost << ".";
                ...
                ws3 << L"Suma este: " << sum_kost_console << ".";
                ...
                ws << L"Pariul tău s-a dublat, pariul tău este = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Ai pierdut pariul!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Oferta dvs. a fost anulată, oferta dvs. este = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Ai câștigat un pariu și vei câștiga un pariu de încă patru!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Pariul tău a crescut cu patru, pariul tău este = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
