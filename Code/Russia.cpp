...
int IntructionRus();
int ViborKostRus();
int ViborStavkaRus(int sumkost);
int gameRus(int stavka_number, int summkost);
int ResultRus(int summkost, int stavka_number);

int MenuRus()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Кости", sf::Style::Close);
    ...
    TextHeading.setString(L"   Игра Кости\nГлавное меню");
    ...
    TextGame.setString(L"Начать игру");
...
int IntructionRus()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Кістки", sf::Style::Close);
    window.setFramerateLimit(144);
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Инструкция");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Игра Кости - это игра, которая моделирует два кубика в диапазоне \nот 1 до 6 (в суммарности выходит К 12). Например: Если сумма\nцифр, выпавших меньше 7 и игрок задумал число меньше 7,\nон выигрывает сделанную ставку.Если сумма выпавших цифр\nбольше 7 и игрок задумал число больше 7, он также выигрывает\nсделанную ставку. Если играющий угадал сумму цифр, он\nполучает вчетверо больше очков, чем сделанная ставка. Ставка\nпроиграна, если нет ни одной из описанных ситуаций. В\nначальный момент у играющего 100 очков.");
    TextInstruction.setCharacterSize(40);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Вийти з гри");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Выбор языка");
    ...
    TextMenu.setString(L"Вернуться к меню");
    TextMenu.setCharacterSize(40);
    TextMenu.setFillColor(sf::Color::White);
    TextMenu.setPosition(1060, 875);
...
int ViborKostRus()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Выбор суммы костей");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Выйти из игры");
    TextExit.setCharacterSize(35);
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(75, 590);

    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"Начать\n   игру\nзаново");
    TextGame.setCharacterSize(35);
    TextGame.setFillColor(sf::Color::White);
    TextGame.setPosition(530, 550);

    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Вернуться\n         к\n     меню");
    TextMenu.setCharacterSize(35);
    TextMenu.setFillColor(sf::Color::White);
    TextMenu.setPosition(1270, 550);

    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Выбрать\n  другой\n   язык");
    TextLanguage.setCharacterSize(35);
    TextLanguage.setFillColor(sf::Color::White);
    TextLanguage.setPosition(1670, 550);

    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Выберите сумму костей для дальнейшей игры.\n(Чтобы выбрать сумму костей, нужно нажать на поле с цифрой.)");
...
int ViborStavkaRus(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Выбор ставок");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Выберите сумму ставки для дальнейшей игры.\n(Чтобы выбрать сумму ставки, нужно щелкнуть на поле с цифрой.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(110, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameRus(stavka_number, summkost);
            }
        }
...
int ResultRus(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Результат игры");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Выйти из игри");
    TextExit.setCharacterSize(45);
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(120, 875);
    ...
    TextLanguage.setCharacterSize(45);
    TextLanguage.setFillColor(sf::Color::White);
    TextLanguage.setPosition(600, 875);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Вы выиграли ставку!");
                ...
                ws1 << L"Вам выпали кости " << kost1 << L" и " << kost2 << ".";
                ...
                ws2 << L"Сумма костей, которые вы выбрали: " << number_sum_kost << ".";
                ...
                ws3 << L"В сумме выходит: " << sum_kost_console << ".";
                ...
                ws << L"Ваша ставка увеличилась в два, ваша ставка составляет = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Вы проиграли ставку!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Ваша ставка аннулирована, ваша ставка составляет = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
                TextHeading.setPosition(220, 600);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Вы выиграли ставку и выигрываете ставку в четверо больше!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Ваша ставка увеличилась в четверо, ваша ставка составляет =" << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
