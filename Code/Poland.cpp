...
int IntructionPl();
int ViborKostPl();
int ViborStavkaPl(int sumkost);
int gamePl(int stavka_number, int summkost);
int ResultPl(int summkost, int stavka_number);

int MenuPl()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Kości", sf::Style::Close);
    ...
    TextHeading.setString(L"   Gra w kości\n  Menu główne");
    ...
    TextGame.setString(L"Rozpocznij grę");
    ...
    TextExit.setString(L"Wychodzenie z gry");
    TextExit.setCharacterSize(40);
    TextExit.setFillColor(sf::Color::Black);
    TextExit.setPosition(770, 890);
...
int IntructionPl()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Instrukcja");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(800, 30);

    sf::Text TextInstruction;
    TextInstruction.setFont(FontExplanatory);
    TextInstruction.setString(L"Gra w kości to gra symulująca dwie kości w zakresie od 1 do 6 (w \nsumie do 12). Na przykład: Jeśli suma wyrzuconych liczb jest \nmniejsza niż 7, a gracz odgadł liczbę mniejszą niż 7, wygrywa \npostawiony zakład, jeśli suma wyrzuconych liczb jest większa \nniż 7, a gracz odgadł liczbę większy niż 7, wygrywa także \npostawiony zakład. Jeśli gracz odgadł sumę liczb, otrzyma \nczterokrotnie więcej punktów niż postawiony zakład. Zakład \njest przegrany, jeżeli nie zaistnieje żadna z opisanych sytuacji. \nW momencie startowym gracz posiada 100 punktów.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Opuść grę");
    TextExit.setCharacterSize(45);
    TextExit.setFillColor(sf::Color::White);
    TextExit.setPosition(160, 875);

    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Wybór języka");
    TextLanguage.setCharacterSize(45);
...
int ViborKostPl()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Wybór sumy kostek");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Wybierać\n   drugi\n    język");
    ...
    TextExplanatory.setString(L"                      Wybierz sumę kostek do dalszej gry.\n(Aby wybrać sumę kostek, musisz kliknąć pole z liczbą.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(300, 780);
...
int ViborStavkaPl(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Wybór stawek");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Wybierz kwotę zakładu do dalszej gry.\n(Aby wybrać kwotę zakładu, musisz kliknąć pole z liczbą.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(300, 780);
...
int ResultPl(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Wynik gry");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    TextHeading.setPosition(800, 0);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Wygrałeś zakład!");
                ...
                ws1 << L"Wypadły ci kości " << kost1 << L" І " << kost2 << ".";
                ...
                ws2 << L"Suma wybranych kości: " << number_sum_kost << ".";
                ...
                ws3 << L"Suma to: " << sum_kost_console << ".";
                ...
                ws << L"Twój zakład został podwojony, Twój zakład wynosi = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Przegrałeś zakład!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Twoja oferta została anulowana, Twoja oferta wynosi = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
                TextHeading.setPosition(150, 600);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Wygrałeś zakład i wygrasz zakład o kolejne cztery!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Twój zakład wzrósł o cztery, Twój zakład wynosi = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
