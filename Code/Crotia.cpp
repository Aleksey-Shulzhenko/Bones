...
int IntructionCro();
int ViborKostCro();
int ViborStavkaCro(int sumkost);
int gameCro(int stavka_number, int summkost);
int ResultCro(int summkost, int stavka_number);
...
int MenuCro()
{
    ...
    TextHeading.setString(L"   Igra s kockicama\nGlavni izbornik");
    ...
    TextGame.setString(L"Započni igru");
    ...
    TextInstruction.setString(L"Uputa");
    ...
    TextLanguage.setString(L"Izbor jezika igre");
    ...
    TextExit.setString(L"Izlazak iz igre");
...
int IntructionCro()
{
    ...
    TextInstruction.setString(L"Igra s kockicama je igra koja simulira dvije kockice u rasponu od 1\n do 6 (ukupno do 12). Na primjer: Ako je zbroj\nispuštenih brojeva manji od 7, a igrač je pogodio broj manji od 7,\non dobiva uloženu okladu\nako je zbroj ispuštenih brojeva veći od 7, a igrač je pogodio broj veći od 7, on također dobiva\npoloženu okladu. Ako je igrač pogodio zbroj brojeva,\ndobija četiri puta više bodova od oklade. Oklada je izgubljena ako ne postoji niti jedna od opisanih situacija. U \npočetnom trenutku igrač ima 100 bodova.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Prekini igru");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Izbor jezika");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Povratak na izbornik");
...
int ViborKostCro()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Izbor zbroja kocke");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Odaberite\n   drugi\n   jezik");
    ...
    TextExplanatory.setString(L"                      Odaberite zbroj kockica, za daljnju igru.\n(Za odabir zbroja kockica potrebno je kliknuti na polje s brojem.)");
...
int ViborStavkaCro(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Odabir stopa");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Odaberite iznos uloga, za daljnju igru.\n(Za odabir iznosa uloga potrebno je kliknuti na polje s brojem.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameCro(stavka_number, summkost);
            }
        }
...
int ResultCro(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Rezultat igre");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Dobili ste okladu!");
                ...
                ws1 << L"Kosti su ti ispale " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Zbroj kockica koje ste odabrali: " << number_sum_kost << ".";
                ...
                ws3 << L"Zbroj je: " << sum_kost_console << ".";
                ...
                ws << L"Vaš ulog se udvostručio, vaš ulog je = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Izgubili ste okladu!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Vaša ponuda je poništena, Vaša ponuda je =" << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Dobili ste okladu i dobit ćete još četiri oklade!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Vaš ulog je povećan za četiri, vaš ulog je = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
