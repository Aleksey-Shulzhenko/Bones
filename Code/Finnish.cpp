...
int IntructionFin();
int ViborKostFin();
int ViborStavkaFin(int sumkost);
int gameFin(int stavka_number, int summkost);
int ResultFin(int summkost, int stavka_number);

int MenuFin()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Luut", sf::Style::Close);
    ...
    TextHeading.setString(L"   Noppapeli\nPäävalikko");
    ...
    TextGame.setString(L"Aloita peli");
    ...
    TextInstruction.setString(L"Ohje");
    ...
    TextLanguage.setString(L"Pelin kielen valinta");
    ...
    TextExit.setString(L"Pelistä poistuminen");
    ...
    TextAvtor.setString(L"Tekijä: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionFin()
{
    ...
    TextInstruction.setString(L"Noppapeli on peli, joka simuloi kahta noppaa välillä 1\n6 (yhteensä jopa 12). Esimerkki: Jos pudonneiden numeroiden summa\n on pienempi kuin 7 ja pelaaja arvasi luvun, joka on pienempi kuin 7,\nhän voittaa tehdyn vedon. Jos laskettujen numeroiden summa\ on suurempi kuin 7 ja pelaaja arvasi luvun suurempi kuin 7, hän voittaa myös tehdyn vedon. Jos pelaaja arvasi numeroiden summan, hän\nsaa neljä kertaa enemmän pisteitä kuin panos on tehty. Veto\on menetetty, jos mitään kuvatuista tilanteista ei ole. \nAloitushetkellä pelaajalla on 100 pistettä.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Lopeta peli");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Kielen valinta");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Palaa valikkoon");
...
int ViborKostFin()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Nopan summan valinta");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Valitse\n   toinen\n   kieli");
    ...
    TextExplanatory.setString(L"                      Valitse nopan summa jatkopelaamista varten.\n(Voit valita nopan summan napsauttamalla kenttää, jossa on numero.)");
...
int ViborStavkaFin(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Kurssien valinta");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Valitse panoksen summa jatkopelaamista varten.\n(Jos haluat valita panoksen määrän, sinun on napsautettava kenttää, jossa on numero.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameFin(stavka_number, summkost);
            }
        }
...
int ResultFin(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Pelin tulos");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Voitit vedon!");
                ...
                ws1 << L"Luusi putosivat " << kost1 << L" та " << kost2 << ".";
                ...
                ws2 << L"Valitsemiesi noppien summa: " << number_sum_kost << ".";
                ...
                ws3 << L"Summa on: " << sum_kost_console << ".";
                ...
                ws << L"Panoksesi on kaksinkertaistunut, panoksesi on = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Hävisit vedon!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Tarjouksesi on peruutettu, tarjouksesi on = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Olet voittanut vedon ja voitat vielä neljän vedon!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Panoksesi on kasvanut neljällä, panoksesi on = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
