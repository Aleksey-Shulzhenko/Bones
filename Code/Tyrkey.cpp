...
int IntructionTyr();
int ViborKostTyr();
int ViborStavkaTyr(int sumkost);
int gameTyr(int stavka_number, int summkost);
int ResultTyr(int summkost, int stavka_number);

int MenuTyr()
{
    sf::RenderWindow window(sf::VideoMode(1920, 1080), L"Kemikler", sf::Style::Close);
    ...
    TextHeading.setString(L"   Zar Oyunu\nAna Menü");
    ...
    TextGame.setString(L"Oyunu başlat");
    ...
    TextInstruction.setString(L"Talimat");
    ...
    TextLanguage.setString(L"Oyun dili seçimi");
    ...
    TextExit.setString(L"Oyundan çıkılıyor");
    ...
    TextAvtor.setString(L"Yazar: Aleksey_Shulzhenko\n     Instagram: @Tlgtms");
...
int IntructionTyr()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Talimat");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    TextInstruction.setString(L"Zar oyunu, 1'den 6'ya kadar (toplamda 12'ye kadar) iki zarı simüle eden bir oyundur. Örneğin: Düşen sayıların toplamı 7'den küçükse ve oyuncu 7'den küçük bir sayı tahmin ederse, yapılan bahsi kazanır. Düşen sayıların toplamı 7'den büyükse ve oyuncu bir sayı tahmin ederse. 7'den büyükse yapılan bahsi de kazanır. Oyuncu sayıların toplamını tahmin ederse, yapılan bahisten dört kat daha fazla puan alır. Açıklanan durumlardan hiçbiri yoksa bahis kaybedilir. \nBaşlangıç ​​anında oyuncunun 100 puanı vardır.");
    TextInstruction.setCharacterSize(45);
    ...
    sf::Text TextExit;
    TextExit.setFont(FontCalibril);
    TextExit.setString(L"Oyunu bırak");
    TextExit.setCharacterSize(45);
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Dil seçimi");
    TextLanguage.setCharacterSize(45);
    ...
    TextMenu.setString(L"Повернутися до меню");
...
int ViborKostTyr()
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Zar toplamı seçimi");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextGame;
    TextGame.setFont(FontCalibril);
    TextGame.setString(L"Başlangıç\n       oyun\n   yeni");
    ...
    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Geri dönmek\n          ile\n       menü");
    ...
    sf::Text TextLanguage;
    TextLanguage.setFont(FontCalibril);
    TextLanguage.setString(L"Seçme\n   diğeri\n   dil");
    ...
    TextExplanatory.setString(L"                      Daha fazla oynamak için zarların toplamını seçin.\n(Zarların toplamını seçmek için sayı içeren alana tıklamanız gerekir.)");
...
int ViborStavkaTyr(int sumkost)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Oranların seçimi");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextExplanatory;
    TextExplanatory.setFont(FontCalibril);
    TextExplanatory.setString(L"                      Daha fazla oynamak için bahis miktarını seçin.\n(Bahis miktarını seçmek için sayı içeren alana tıklamanız gerekir.)");
    TextExplanatory.setCharacterSize(60);
    TextExplanatory.setFillColor(sf::Color::White);
    TextExplanatory.setPosition(120, 780);
    ...
    while (window.isOpen())
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            if (SpriteNumber10.getGlobalBounds().contains(MousePozition.x, MousePozition.y))
            {
                ...
                Sleep(500);
                window.close();
                gameTyr(stavka_number, summkost);
            }
        }
...
int ResultTyr(int summkost, int stavka_number)
{
    ...
    sf::Text TextHeading;
    TextHeading.setFont(FontArimoSemiBold);
    TextHeading.setString(L"Oyunun sonucu");
    TextHeading.setCharacterSize(75.6);
    TextHeading.setFillColor(sf::Color::White);
    ...
    sf::Text TextMenu;
    TextMenu.setFont(FontCalibril);
    TextMenu.setString(L"Menüye dön");
    TextMenu.setCharacterSize(30);
    TextMenu.setFillColor(sf::Color::White);
    TextMenu.setPosition(1070, 885);
    ...
    while (window.isOpen())
    {
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < number_sum_kost)
            {
                ...
                TextHeading1.setString(L"Ви виграли ставку!");
                ...
                ws1 << L"Вам випали кістки " << kost1 << L" та " << kost2 << ".";
                ...
                ws3 << L"В сумi виходить: " << sum_kost_console << ".";
                ...
                ws << L"Ваша ставка збiльшилася в двоє, ваша ставка становить = " << stavka_conclusion << ".";
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console < 7.2)
            {
                if (sum_kost_console > number_sum_kost)
                {
                    sf::Text TextHeading1;
                    TextHeading1.setFont(FontArimoSemiBold);
                    TextHeading1.setString(L"İddiayı kazandın!");
                    TextHeading1.setCharacterSize(50);
                    TextHeading1.setFillColor(sf::Color::White);
                    TextHeading1.setPosition(740, 200);
                    ...
                    TextHeading2.setFont(FontArimoSemiBold);
                    std::wstringstream ws1;
                    ws1 << L"Kemiklerin düştü " << kost1 << L" та " << kost2 << ".";
                    TextHeading2.setString(ws1.str());
                    TextHeading2.setCharacterSize(50);
                    TextHeading2.setFillColor(sf::Color::White);
                    TextHeading2.setPosition(700, 300);
                    ...
                    TextHeading3.setFont(FontArimoSemiBold);
                    std::wstringstream ws2;
                    ws2 << L"Seçtiğiniz zarların toplamı: " << number_sum_kost << ".";
                    TextHeading3.setString(ws2.str());
                    TextHeading3.setCharacterSize(50);
                    TextHeading3.setFillColor(sf::Color::White);
                    TextHeading3.setPosition(640, 400);
                    ...
                    TextHeading.setFont(FontArimoSemiBold);
                    std::wstringstream ws;
                    ws << L"Bahsiniz ikiye katlandı, bahsiniz = " << stavka_conclusion << ".";
                    TextHeading.setString(ws.str());
                    TextHeading.setCharacterSize(50);
                    TextHeading.setFillColor(sf::Color::White);
                    TextHeading.setPosition(180, 600);
        ...
        if (number_sum_kost < 7.2)
        {
            if (sum_kost_console > 7.8)
            {
                sf::Text TextHeading1;
                TextHeading1.setFont(FontArimoSemiBold);
                TextHeading1.setString(L"Bahsi kaybettin!");
                TextHeading1.setCharacterSize(50);
                TextHeading1.setFillColor(sf::Color::White);
                TextHeading1.setPosition(740, 200);
                ...
                TextHeading.setFont(FontArimoSemiBold);
                std::wstringstream ws;
                ws << L"Teklifiniz iptal edildi, teklifiniz = " << stavka_conclusion << ".";
                TextHeading.setString(ws.str());
                TextHeading.setCharacterSize(50);
                TextHeading.setFillColor(sf::Color::White);
        ...
        if (number_sum_kost == sum_kost_console)
        {
            sf::Text TextHeading1;
            TextHeading1.setFont(FontArimoSemiBold);
            TextHeading1.setString(L"Bir bahis kazandınız ve dört bahis daha kazanacaksınız!");
            TextHeading1.setCharacterSize(50);
            TextHeading1.setFillColor(sf::Color::White);
            TextHeading1.setPosition(740, 200);
            ...
            TextHeading.setFont(FontArimoSemiBold);
            std::wstringstream ws;
            ws << L"Bahsiniz dört kat arttı, bahsiniz = " << stavka_conclusion << ".";
            TextHeading.setString(ws.str());
            TextHeading.setCharacterSize(50);
            TextHeading.setFillColor(sf::Color::White);
            TextHeading.setPosition(180, 600);
